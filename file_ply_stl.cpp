...
_file_ply::_file_ply(){
	...
	char *Text_tokens[]={"ply","format","ascii","element","vertex","face","end_header","zzzzzzzz",""};
...
int _file_ply::
read(QVector<float> &Vertices,QVector<int> &Faces)
{
int Next_token,i,j;
...
//******************************************************************************
/*
int _file_ply::write(QVector<float> &Vertices,QVector<int> &Faces)
{
}
*/
//******************************************************************************
...
for (unsigned int i=0;i<strlen(Aux_token);i++)
	{
        if ((p1=strchr("0123456789.+-eE",Aux_token[i]))==NULL) return(-1);
	}
return(0);
}
